...
HISTORICAL_START = "2022-11-29"  # for actuals (Open-Meteo archive)
HISTORICAL_END = "2024-12-25"  # for actuals
...
TOMMORROWS_DATE = datetime.date.today() + datetime.timedelta(days=1)